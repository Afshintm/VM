...
{
    /// <summary>
    /// A class that finds types needed by the Project by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft";//"|^CppCodeProvider|^VJSharpCodeProvider|^WebDev|^Autofac|^DevArt|^FluentValidation|^Inetlab|^Moq|^Newtonsoft|^Ninject|^PostSharp|^Castle|^Iesi|^log4net|^NHibernate|^nunit|^TestDriven|^MbUnit|^Rhino|^QuickGraph|^TestFu|^Telerik|^ComponentArt|^MvcContrib|^AjaxControlToolkit|^Antlr3|^Remotion|^Recaptcha";
        ...
        /// <summary>Gets or sets wether we should iterate assemblies in the app domain when loading project types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Ioc assemblies arn't investigated (e.g. by not including something like "^Ioc|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Ioc factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Ioc.
        /// </returns>
